...
namespace messaging {
  ...
  public:
    ...
    void send(Message const &msg) const {
      if(q) {
        q->push(msg);
      }
    }
  ...
  class TemplateDispatcher {
    ...
    template <typename Dispatcher,
      typename OtherMsg, typename OtherFunc>
  ...
  public:
    TemplateDispatcher(
      TemplateDispatcher &&other) :
      q(other.q),
      prev(other.prev), f(std::move(other.f)),
    ...
    TemplateDispatcher(queue *q_,
      ...
      q(q_),
      prev(prev_), f(std::forward<Func>(f_)),
      chained(false) {
      prev_->chained = true;
    }
  ...
  public:
    ...
    handle(Func &&f) {
      return TemplateDispatcher<dispatcher,
        Message, Func>(
